...
You have not been coached through setting up a Python environment.  You will need to set up a Python environment and install the necessary packages to run this code.  Alternatively, delete the Python code and only leave the remaining R code that is provided.  You can see the executed Python output at my Github page at https://flyaflya.github.io/decTreeChallenge/.
...
3. **GitHub Repository:** Use your forked repository (from the starter repository) named "decisionTreeChallenge" in your GitHub account.
