...
- **Anticiapted Non-linear Relationships:** Real estate prices have complex, non-linear relationships between features (e.g., square footage in wealthy vs. poor zip codes affects price differently)
...
The results show a clear trend: as we increase the number of trees from 1 to 5,000, both RMSE decreases and R-squared increases. This demonstrates the fundamental principle of ensemble learning analagous to the 'wisdom of crowds' phenomenon.
...
## Key Insights: Why Random Forests Outperform Linear Regression and why it didn't happen here
...
## Apparently, Random Forests Didn't SIGNIFICANTLY (say 10% RMSE improvement) Outperform Linear Regression Here

Going with random forests in this dataset didn't significantly outperform linear regression.  This is likely because the dataset is not very complex, was collected from a homogeneous town in Iowa (Ames, Iowa), and thus the advantage of being able to capture non-linear relationships between the features and the target variable is not as great.
